...
export const roles: { [k: string]: () => Role } =
    {
        ...
        prowler: () => ({
            ...
            roleName: 'Сова 🦉',
            weight: '-4',
            nightAction: 'Каждую ночь может посмотреть в окно одного из игроков и узнать спит он или нет. Если же его съедят, узнает имена всех волков.',
        }),
        sorcerer: () => ({
            ...roles.wolf(),
            roleName: 'Колдунья 🔮',
        ...
        thief: () => ({
            ...
            notes: ['Не может украсть роль у Двойника.'],
        }),
        arsonist: () => ({
