...
export class Martyr extends RoleBase {
    ...
    startMessageText = () => 'В начале игры ты выбираешь человека, ' +
        'за которого умрёшь. Если этот человек умрёт, ты умрёшь за него, ' +
        'и этот человек выживет. Пока ты не умрёшь, ты в команде селян, ' +
        'но как только ты умер(ла) за кого-то, ты можешь выиграть, ' +
