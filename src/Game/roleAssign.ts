...
import {
    ...
    Mason, Monarch, Necromancer, Oracle, Sandman, Seer, Pacifist,
    SerialKiller,
...
export const assignRoles = (game: Game) => {
    ...
    const villagersPool = [
        ...
        WiseElder, Sandman, Blacksmith, Pacifist, WildChild, Detective, Martyr,// Active Villagers
    ...
    const testPool = [
        Pacifist, JackOLantern, Villager, Thief, Wolf, Beauty,
