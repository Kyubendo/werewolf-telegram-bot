...
export const assignRoles = (game: Game) => {
    ...
    const rolePool = [
        Roles.Wolf, Roles.Cursed, Roles.Mason, Roles.Mason, Roles.Mason, Roles.Harlot, Roles.Monarch, Roles.ApprenticeSeer, Roles.Mason, Roles.Thief, Roles.SerialKiller, Roles.Lycan, Roles.Cursed, Roles.Seer,
